package com.liuming.springandlangchain4j.generator;
...
//自动生成Entity、Mapper、Service、Controller文件夹的代码，另外生成Mapper XML（自动放在resource文件夹了）
public class MyBatisCodeGenerator {
    ...
    public static GlobalConfig createGlobalConfig() {
        ...
        globalConfig.getPackageConfig()
                .setBasePackage("com.liuming.springandlangchain4j.generator");
